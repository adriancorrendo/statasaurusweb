...
=======
Neither of both, Frequentist or Bayesian, are always the most suitable solution for your analysis.
>>>>>>> d152dcfdfef1bd529bde779e789a5b8cf794947f
:::
...
$$ P(A_{true} | B)  = \frac{P(B|A_{true}) * P(A_{true})}{P(B)}$$ 
