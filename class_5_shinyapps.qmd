...
-   Offering interactive recommendation guidelines.
    ...
    -   See [cornyield0N](ciampittilab.shinyapps.io/cornyield0N/), [DONMaiz](ciampittilab.shinyapps.io/DONMaiz/), [SoybeanVRS](https://analytics.iasoybeans.com/cool-apps/SoybeanVRSsimulator/)

-   Facilitating the use of software development by peers (e.g. demo of R packages)

    -   See [soiltestcorr](ciampittilab.shinyapps.io/soiltestcorr/), [metrica](ciampittilab.shinyapps.io/metrica/)
:::
...
knitr::include_url("https://ciampittilab.shinyapps.io/soiltestcorr/")
...
-   **Display code in place**: for teaching, the RMarkdoen syntax using chunks allows us to eventually display the code within the same location on the UI.
...
Let's see an example code using Flexdashboard
...
knitr::include_url("https://ciampittilab.shinyapps.io/metrica/")
