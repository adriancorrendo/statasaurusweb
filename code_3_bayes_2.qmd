...
4. "**Accept**" that combination of parameters if the difference < predifined acceptable error.
   "**Reject**" if the difference > predifined acceptable error.
...
4. "**Accept**" (gold) that combination of parameters if the difference < predifined acceptable error.
   "**Reject**" (red) if the difference > predifined acceptable error.
...
More efficient than AR sampling.  
